...
class Authentification extends Controller
{
    ...
    public function ResetMDP()
    {
        ...
        /*
        $isPassword = Utilisateur::goodMdpWithId($userID, $dataArray["password_old"]); 
        // $resetMdp = UserResetMdp::get

        if (!$isPassword ) {
            Reponse::create(Reponse::ERROR, "Attention, vous avez commis une erreur sur l'ancien mot de passe")->sendJson();
        }*/
