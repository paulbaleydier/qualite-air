                    ...
                    <div class="card shadow p-3" id="card-crud-user">
                        ...
                        <div class="card-footer">
                            ...
                            <?php } else { ?>
                                <!-- Create -->
                                <div class="p-2 d-flex justify-content-around">
                                    <button class="btn btn-danger" onClick="history.back();"><i class="fa-solid fa-xmark me-2"></i>
                                        Annuler</button>
                                    <button class="btn btn-success" id="btn-create-account"><i class="fa-solid fa-check me-2"></i>
                                        Sauvegarder</button>
                                </div>
                            <?php } ?>
